import { DEFAULT_WIDGET_HEIGHT, DEFAULT_WIDGET_WIDTH } from './defines';
...
export class WaveFormGraph {
    ...
    protected colorPositive = '#0f0';
    protected colorNegative = '#0a0';
    ...
    protected drawLineSegment(x: number, y: number, width: number, isEven: boolean) {
    ...
    protected createWaveForm(decodedBuffer: AudioBuffer) {
        ...
        const maxHeight = this.height; // HEIGHT / 2;
